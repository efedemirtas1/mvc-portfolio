<div class="intro-y flex flex-col sm:flex-row items-center mt-8">
    ...
    <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
        <a href="<?php echo base_url("admin/{$viewFolder}/add");?>" class="button text-white bg-theme-1 shadow-md mr-2">Yeni Yazı Ekle</a>
    ...
    <table class="table table-report table-report--bordered display datatable w-full">
        <thead>
            <tr>
                ...
                <th class="whitespace-no-wrap">Blg Adı</th>
                <th class="text-center whitespace-no-wrap">Yayın Tarihi</th>
                <th class="whitespace-no-wrap w-20">Kategori</th>
                <th class="text-center whitespace-no-wrap w-16">Anasayfa</th>
            ...
            <tr class="intro-x" id="ord-<?=$rows->id?>">
                ...
                <td>
                    <div class="flex sm:justify-start">
                        <?php 
                            //Kayıt resimlerini listelemek için foksiyona(kayıt id, viewFolder, modela adını) gönderin.
                ...
                <td>
                    ...
                    <div class="text-gray-600 text-xs"><?=character_limiter($rows->short_description, 100)?></div>
                </td>
                <td class="text-center"><?=date('d/m/Y H:i', strtotime($rows->creat_date))?></td>
