<div class="pos intro-y grid grid-cols-12 gap-5 mt-8">
    ...
    <div class="intro-y col-span-12 lg:col-span-8">
        <form action="<?php echo base_url("admin/{$viewFolder}/update/$item->id");?>" method="post">
            ...
            ?>
            <input type="text" class="input input--lg w-full border mt-2 mb-2 <?=$alertFormClass?>" placeholder="Ürün Adı" name="title" value="<?=$item->title?>" id="title">
            <?=$alertFormMessage?>
            
            <div class="post intro-y overflow-hidden box mt-5">
                <div class="post__tabs nav-tabs flex flex-col sm:flex-row bg-gray-200 text-gray-600">
                    <a title="Ürün genel bilgileri" data-toggle="tab" data-target="#bilgi" href="javascript:;" class="tooltip w-full sm:w-40 py-4 text-center flex justify-center items-center active"> <i data-feather="file-text" class="w-4 h-4 mr-2"></i> İçerik Bilgileri </a>
                    <a title="Ürün detayı" data-toggle="tab" data-target="#icerik" href="javascript:;" class="tooltip w-full sm:w-40 py-4 text-center flex justify-center items-center"> <i data-feather="align-left" class="w-4 h-4 mr-2"></i> İçerik </a>
                    ...
                    <div class="tab-content__pane p-5 active" id="bilgi">
                        <div class="border border-gray-200 rounded-md p-5">
                            <div class="grid grid-cols-12">
                                <div class="intro-x col-span-8 mt-5">
                                    <div class="font-medium flex items-center border-b border-gray-200 pb-5"> <i data-feather="layout" class="w-4 h-4 mr-2"></i>Sayfa Şablonu</div>
                                    <div class="mt-5 mb-5">
                                        <select  class="input input--lg w-full border" name="template" id="sablon" required>
                                            <?php
                                                if($item->template == 1){
                                                    echo '<option value="0" >Seçiniz</option>';
                                                    echo '<option value="1" selected>Şablon 1</option>';
                                                    echo '<option value="2">Şablon 2</option>';
                                                    echo '<option value="3">Şablon 3</option>';
                                                }elseif($item->template == 2) {
                                                    echo '<option value="0" >Seçiniz</option>';
                                                    echo '<option value="1">Şablon 1</option>';
                                                    echo '<option value="2" selected>Şablon 2</option>';
                                                    echo '<option value="3">Şablon 3</option>';
                                                }elseif($item->template == 3) {
                                                    echo '<option value="0" >Seçiniz</option>';
                                                    echo '<option value="1">Şablon 1</option>';
                                                    echo '<option value="2">Şablon 2</option>';
                                                    echo '<option value="3" selected>Şablon 3</option>';
                                                }else{
                                                    echo '<option value="0">Seçiniz</option>';
                                                    echo '<option value="1">Şablon 1</option>';
                                                    echo '<option value="2">Şablon 2</option>';
                                ...
                                <div class="intro-x col-span-4 p-3">
                                    <div class="border rounded border-gray-200 p-2" id="sonuc">
                                        <?php
                                            if($item->template == 1){
                                                echo '<img src="assets/admin/images/sablon1.jpg" alt="Şablon sol menü">';
                                            }elseif($item->template == 2) {
                                                echo '<img src="assets/admin/images/sablon2.jpg" alt="Şablon sol menü yok">';
                                            }elseif($item->template == 3) {
                                                echo '<img src="assets/admin/images/sablon3.jpg" alt="Şablon sol menü yok">';
                                            }else{
                                                echo '<img src="assets/admin/images/sablon1.jpg" alt="Şablon sol menü">';
                                            }
                                        ?>                                        
                    ...
                    <div class="tab-content__pane p-5" id="seo">
                        <div class="border border-gray-200 rounded-md p-5">
                            <div class="mb-5">
                                ...
                                <input type="text" class="input input--lg w-full border mt-2" placeholder="" name="seoUrl" value="<?=$item->seo_url?>" id="seoUrl">
                            </div>
                            <div class="mb-5">
                                ...
                                <input type="text" class="input input--lg w-full border mt-2" placeholder="" name="seoDescription" value="<?=$item->seo_description?>">
                            </div>
                            <div class="mb-5">
                ...
                <div class="border border-gray-200 rounded-md p-5">
                    ...
                    <div class="mt-5">
                        <div class="border-2 border-dashed rounded-md mt-3 pt-4">
                            ...
                            <form action="<?=base_url("admin/imageUpload/$item->id/{$viewFolder}/{$modelName}");?>" data-plugin="dropzone" data-opions="{url<?=base_url("admin/imageUpload/$item->id/{$viewFolder}/{$modelName}");?>}" id="dropzone"  class="dropzone border-gray-200 border-dashed">
