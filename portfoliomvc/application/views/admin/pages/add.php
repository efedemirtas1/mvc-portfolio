        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            <div class="intro-y flex flex-col sm:flex-row items-center">
                ...
                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                    ...
                    <a href="<?php echo base_url("admin/{$viewFolder}");?>"
                        class="button px-2 mr-1 bg-theme-6 text-white"> <i data-feather="x"></i> </a>
                </div>
            </div>
            <?php
                if(isset($form_error)){
            ...
            ?>
            <input type="text" class="input input--lg w-full border mt-2 mb-2<?=$alertFormClass?>" placeholder="Sayfa Adı" name="title" id="title">
            <?=$alertFormMessage?>

            <div class="post intro-y overflow-hidden box mt-5">
                <div class="post__tabs nav-tabs flex flex-col sm:flex-row bg-gray-200 text-gray-600">
                    <a title="Sayfa genel bilgileri" data-toggle="tab" data-target="#bilgi" href="javascript:;" class="tooltip w-full sm:w-40 py-4 text-center flex justify-center items-center active"> <i data-feather="file-text" class="w-4 h-4 mr-2"></i> İçerik Bilgileri </a>
                    <a title="Sayfa detayı" data-toggle="tab" data-target="#icerik" href="javascript:;" class="tooltip w-full sm:w-40 py-4 text-center flex justify-center items-center"> <i data-feather="align-left" class="w-4 h-4 mr-2"></i> İçerik </a>
                        ...
                        <div class="border border-gray-200 rounded-md p-5">
                            <div class="grid grid-cols-12">
                                <div class="intro-x col-span-8 mt-5">
                                    <div class="font-medium flex items-center border-b border-gray-200 pb-5 mb-2"> <i data-feather="layout" class="w-4 h-4 mr-2"></i>Sayfa Şablonu</div>
                                    <select class="input input--lg w-full border" name="template" id="sablon">
                                ...
                                <div class="intro-x col-span-4 p-3">
                                    <div class="border rounded border-gray-200 p-2" id="sonuc">
                                        <img src="assets/admin/images/sablon1.jpg" alt="Şablon Sol menü">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="tab-content__pane p-5" id="seo">
                        <div class="border border-gray-200 rounded-md p-5">
                            ...
                            <div class="mt-5">
                                ...
                                <textarea col="3" class="input input--lg w-full border" name="seoKeyword"></textarea>
                                <div class="text-xs text-gray-600 mt-2">Anahtar kelimelerinizi "," virgül ile ayırarak ekleyebilirsiniz.</div>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="post w-full intro-y overflow-hidden box mt-5">
                <div class="post__content">
                    <div class="border border-gray-200 rounded-md p-5">
                        ...
                        <div class="rounded-md flex items-center px-5 py-4 mb-2 bg-theme-17 text-theme-11"> <i data-feather="alert-octagon" class="w-6 h-6 mr-2"></i> İçerik oluşturulduktan sonra resim ekleme aktif olacaktır. </div>
                    </div>
                </div>
            </div>
        </div>
