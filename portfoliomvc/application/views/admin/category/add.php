        ...
        <div class="intro-y col-span-12 lg:col-span-8">
            <div class="intro-y flex flex-col sm:flex-row items-center">
                ...
                <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                    ...
                    <a href="<?php echo base_url("admin/{$viewFolder}/{$modul}");?>" class="button px-2 mr-1 bg-theme-6 text-white"> <i data-feather="x"></i> </a>
                </div>
            </div>
            <?php
                if(isset($form_error)){
                        ...
                        <div class="border border-gray-200 rounded-md p-5">
                            <div class="grid grid-cols-12">
                                <div class="intro-x col-span-12 mb-5">
                                    <div class="font-medium flex items-center border-b border-gray-200 pb-5 mb-2"> <i data-feather="git-merge" class="w-4 h-4 mr-2"></i>Üst Kategori Seç</div>
                                ...
                                <div class="intro-x col-span-12 mb-5">
                                    ...
                                    <input type="hidden" class="input input--lg w-full border" value="<?=$modul?>" name="modul_metod">
                                    <div class="input input--lg w-full border"><?=$modul?></div>
                                </div>
                            </div>                    
                        </div>                    
                    </div>
