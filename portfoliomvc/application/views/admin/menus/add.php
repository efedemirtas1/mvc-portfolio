                    ...
                    <div class="tab-content__pane p-5 active" id="bilgi">
                        <div class="border border-gray-200 rounded-md p-5">
                            <div class="grid grid-cols-12">
                                ...
                                <div class="intro-x col-span-12 mb-5">
                                    <div class="font-medium flex items-center border-b border-gray-200 pb-5 mb-2"> <i data-feather="layout" class="w-4 h-4 mr-2"></i>Modul Seç</div>
                                    <select class="select2 w-full" name="modulUrl">
                                        <option value="0">Seçiniz</option>
                                        <option value="index">Anasayfa</option>
                                        <?php                                        
                                            foreach($moduls as $rows){
                                                echo '<option value="'.$rows->seo_url.'">'.$rows->title.'</option>';
                                            }
                                        ?>
                    ...
                    <div class="tab-content__pane p-5" id="seo">
                        <div class="border border-gray-200 rounded-md p-5">
                            ...
                            <div class="mb-5">
                                ...
                                <input type="text" class="input input--lg w-full border" placeholder="https://www.google.com" name="externalUrl">
                            </div>            
                        </div>                    
                    </div>
                </div>
